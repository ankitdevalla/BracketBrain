...
# Load the dataset
file_path = "../pre_tourney_data/PreTournamentAdvancedStats_withNames.csv"  # Update if needed
...
top_5_teams = df_2025.sort_values(by="AdjNetRtg", ascending=False).head(10)
